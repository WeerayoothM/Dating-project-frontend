...
function CardProfileEdit(props) {
  ...
  for (let index = 0; index < 9; index++) {
    imageProfile.push(
      props.data &&
        ...
        props.data.Photos[index].imageUrl
    );
  }
  ...
  //                       }}
  //                     >
  //                       <path d="M 14.926 12.56 v -1.14 l 5.282 5.288 c 1.056 0.977 1.056 2.441 0 3.499 c -0.813 1.057 -2.438 1.057 -3.413 0 L 11.512 15 h 1.138 l -5.363 5.125 c -0.975 1.058 -2.438 1.058 -3.495 0 c -1.056 -0.813 -1.056 -2.44 0 -3.417 l 5.201 -5.288 v 1.14 L 3.873 7.27 c -1.137 -0.976 -1.137 -2.44 0 -3.417 a 1.973 1.973 0 0 1 3.251 0 l 5.282 5.207 H 11.27 l 5.444 -5.207 c 0.975 -1.139 2.438 -1.139 3.413 0 c 1.057 0.814 1.057 2.44 0 3.417 l -5.2 5.288 Z"></path>
  //                     </svg>
  //                   </span>
  //                 </button>
  //               </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {imageProfile.map((_, idx) => {
            return (
              <ImageProfileEdit
                imageProfile={imageProfile[idx]}
              ></ImageProfileEdit>
            );
          })}

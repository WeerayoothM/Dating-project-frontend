...
function CardProfile(props) {
  ...
  return (
    <>
      { data &&
        <Col xs={14} sm={15} md={16} lg={17} xl={18} className="playground" style={{ backgroundColor: 'hsl(0,0%,97%)', display: 'flex', justifyContent: 'center', flexDirection: 'column', border: '1px solid' }}>
